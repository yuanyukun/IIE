 ...
 */
public class FlowersToMeAdapter extends RecyclerView.Adapter<FlowersToMeAdapter.ViewHolder> {

    private Context context;
    private LayoutInflater inflater;
    private List<FlowersToMeSubItem> lists;

    public FlowersToMeAdapter(Context context, List<FlowersToMeSubItem> lists) {
        this.context = context;
        this.lists = lists;
        inflater = LayoutInflater.from(context);
    }

    public void RefreshData(List<FlowersToMeSubItem> list){
        this.lists= list;
        notifyDataSetChanged();
    }
    @Override
    public FlowersToMeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = inflater.inflate(R.layout.flowers_to_me_list, parent, false);
        return new ViewHolder(layout);
    }

    @Override
    public void onBindViewHolder(final FlowersToMeAdapter.ViewHolder holder, final int position) {
         final FlowersToMeSubItem subItem = lists.get(position);
        ...
        describe.append("送我");
        describe.append(subItem.getFlowersNum()+"朵鲜花");
...
//                Log.d("加关注",response);
    ...
    private HashMap<String,String> buildRequestParams(FlowersToMeSubItem subItem) {
