 ...
 */
public class FragmentDiscoverBallonAdapter extends RecyclerView.Adapter<FragmentDiscoverBallonAdapter.ViewHolder> {

    private Context context;
    private LayoutInflater inflater;
    private List<BalloonListSubBeanItem> lists;

    public FragmentDiscoverBallonAdapter(Context context, List<BalloonListSubBeanItem> lists) {
    ...
    @Override
    public FragmentDiscoverBallonAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = inflater.inflate(R.layout.fragement_discover_balloon, parent, false);
        return new ViewHolder(layout);
    }

    @Override
    public void onBindViewHolder(final FragmentDiscoverBallonAdapter.ViewHolder holder, final int position) {
