 ...
 */
public class PopupTaskInfo extends PopupWindow{


    private Activity activity;
    private SubTaskBean[] lists;
    private int position;
    private LayoutInflater mInflater;

    public PopupTaskInfo(Activity activity, SubTaskBean[] lists, int position) {
    ...
    private void init() {
        ...
        PopupTaskRecyclerViewAdapter adapter = new PopupTaskRecyclerViewAdapter(activity,lists,activity);
