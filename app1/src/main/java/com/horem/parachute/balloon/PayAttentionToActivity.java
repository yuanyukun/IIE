...
public class PayAttentionToActivity extends BaseActivity implements AMapLocationListener{
    ...
    private void initData() {
        ...
        OkHttpClientManager.postAsyn(HttpUrlConstant.flowersMyFollowList, new OkHttpClientManager.ResultCallback<FansBean>() {
            @Override
...
//                Log.d(getClass().getName(),response);
    ...
    private void init() {
        ...
        initMap();
        mRecyclerView = (XRecyclerView) findViewById(R.id.recycler_user_info_pay_attention_list);
