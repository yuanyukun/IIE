...
public interface AppUpdateInterface {
	 ...
	 * @param displayer
	 */
	void setCustomDisplayer(DisplayerInterface displayer);
	 ...
	 * @param parser
	 */
	void checkLatestVersion(String url, ResponseParserInterface parser);
	 ...
	 * @param url
	 */
	void downloadAndInstall(String targetVersion);
	 ...
	 */
	void checkAndUpdateDirectly(String url, ResponseParserInterface parser);
