...
public class OkHttpClientManager
{
     ...
     * @param maps
     */
    private Response _postAsyn(String url, HashMap<String,String> maps)throws IOException
    {
...
//                    ops.inSampleSize = inSampleSize;
     ...
     * @return
     */
//    public static String formatParams(Param params){
...
//   s
     ...
     * @param callback
     */
    public static void getAsyn(String url, ResultCallback callback,HashMap<String,String> map)
    {
        String httpUrl = getHttpUrl(url,map);
//        Log.d("拼接后的URL",httpUrl);
        getInstance()._getAsyn(httpUrl, callback);
    }
     ...
     * @throws IOException
     */
    public static Response postAsyn(String url,HashMap<String,String> params)throws IOException
    {
    ...
    //异步单文件上传，带参数
    public static void postAsyn(String url, ResultCallback callback, File file, String fileKey, HashMap<String,String> params) throws IOException
    {
        getInstance()._postAsyn(url, callback, file, fileKey, params);
    }
