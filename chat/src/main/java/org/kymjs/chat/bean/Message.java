...
public class Message {
    ...
    private Long id;
    private int type; // 3-text | 1-photo | 2-face | more type ...
    private int state; // 3-sending | 1-success | 2-fail
    private String fromUserName;        //自己名字
    private String fromUserAvatar;      //自己头像
    private String toUserName;          //对方名字
    private String toUserAvatar;        //对方头像
